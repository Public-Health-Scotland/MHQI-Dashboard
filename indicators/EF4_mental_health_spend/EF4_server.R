...
# Alt Text ----
altTextServer("EF4_trendPlot_modal",
              title = "Time trend of mental health and CAMHS spend",
              content = tags$ul(tags$li(
              "This is a plot showing the percentage of total spend that is attributable
              to total mental health spend and/or CAMHS expenditure for each financial year
              by health board of treatment."),
              tags$li("The x axis shows the financial year, starting from...TO DO."),
              tags$li("The y axis shows the percentage of total spend.")))
