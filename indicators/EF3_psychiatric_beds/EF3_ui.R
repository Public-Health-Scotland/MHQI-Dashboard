  ...
  fluidRow(
    tabBox(width = NULL,
           ...
           tabPanel("Infographic",
                    tagList(
                      linebreaks(1),
                      altTextUI("EF3_infographic_modal"),
                      img(src='infographics/EF3.png',
                          class = "infographic",
                          alt = "The total number of average available staffed beds 
                          per day for all psychiatric specialties in 2024/25 in Scotland 
                          was 3,527 beds (i.e. 64.1 psychiatric beds per 100,000 population). 
                          This is a decrease from 64.9 beds per 100,000 population 
                          in 2023/24 and 66.7 beds per 100,000 population in 2022/23.")
                    )
           ), 
           # Data table
