tagList(
  ...
  # Title for P1 tab ----
  fluidRow(width = 12,
           h1("P3 - % of replies for people with mental health problem that agree 
              with statement 'people took account of the things that mattered to me'"),
  ...
  fluidRow(
    tabBox(width = NULL,
           ...
           tabPanel("Infographic",
                    tagList(
                      linebreaks(1),
                      altTextUI("P3_infographic_modal"),
                      img(src='infographics/P3.png',
                          class = "infographic",
                          alt = "In Scotland in 2025/26 56% (confidence interval: 53%; 58%) 
                          of people with a mental health condition agreed that people 
                          took account of the things that mattered to them. There was 
                          no change from the last available figure (56%) in 2023/24.")
                    )
           ), 
           # Data table
