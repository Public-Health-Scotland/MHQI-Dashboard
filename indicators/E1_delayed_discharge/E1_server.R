...
# Alt Text ----
altTextServer("E1_plot1_modal",
              title = "Time trend of delayed discharge days",
              content = tags$ul(tags$li("This is a plot showing the total number of days spent in hospital 
                                        for mental health specialties when patients are ready to be discharged 
                                        over time, broken down by either council are of residence or health 
                                        board of treatment."),
                                tags$li("The x axis shows the financial year, starting from...TO DO."),
                                tags$li("The y axis shows the total number of days.")))

# Alt Text ---- [NEEDS UPDATING]
altTextServer("E1_plot2_modal",
              title = "Time trend of delayed discharge days",
              content = tags$ul(tags$li("This is a plot showing the total number of days spent in hospital 
                                        for mental health specialties when patients are ready to be discharged 
                                        over time, broken down by either council are of residence or health 
