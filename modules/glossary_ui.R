        ...
        fluidPage(
            mainPanel(
              ...
              during the financial year."),
                ...
                p("The National Records of Scotland (NRS) define probable suicides as deaths 
                resulting from intentional self-harm (codes X60–X84, Y87.0 of the International 
                Classification of Diseases, Tenth Revision (ICD-10)) and events of undetermined intent
                (ICD-10 codes Y10–Y34, Y87.2). 
                'Events of undetermined intent' are cases where it is not clear whether the death was 
                the result of intentional self-harm, an accident or an assault. It is thought that most of 
                these deaths are likely to be suicides, and NRS therefore combine these with the 
                'intentional self-harm' deaths to produce their statistics. As some 'undetermined intent'
                  deaths may not have been suicides, inclusion of these cases may overestimate the number of
                  'true' (but unknowable) suicide deaths."),
