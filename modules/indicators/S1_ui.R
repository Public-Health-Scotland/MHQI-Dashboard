tabItem(tabName = S1_tab,
        fluidPage(
          ...
          mainPanel(
            img(src='infographics/S1_20231023.png',
                class = "infographic",
                alt = paste0("For the five year period 2016 to 2020, the crude ",
                             "suicide rate per 100,000 population in Scotand was ",
                             "13.7 compared to 13.5 for the five year period 2011-2015.")),
            br(),
            p("Further information can be found in the [THIS LINK IS BROKEN]",
