tabItem(tabName = T2_tab,
        fluidPage(
          headerPanel(fluidRow("T2 - % of young people who commence treatment by 
                     ...
                     "Sub title")),
          mainPanel(
            img(src='infographics/T2_20230921.png',
                class = "infographic",
                alt = paste0("Over seven out of ten (70.3%) children and young people ",
                             ...
                             "Half of children and young people started treatment within seven weeks ",
                             "in the quarter ending 31 December 2021")),
            br(),
