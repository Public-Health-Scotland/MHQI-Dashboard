tabItem(tabName = S2_tab,
        fluidPage(
          ...
          mainPanel(
            img(src='infographics/S2_20231106.png',
                class = "infographic",
                alt = paste0("For the quarter ending 31 December 2021, the ",
                             "percentage of discharged psychiatric inpatients ",
                             "followed-up by community mental health services ",
                             "within 7 calendar days ranged from 17.6% to 88.1%")),
            br(),
            p(paste0("The data for S2 is sourced from board returns, which may be incomplete.")),
            br(),
